...
st.title('Stock Plotter 📈 sheet name is Export')
...
if uploaded_file:
    ...
    groupby_column = st.selectbox(
        ...
        ('SITECODE_OSPID','STORE_TYPE', 'ARTICLE_NO', 'ARTICLE_DESC','MAIN_GROUP_ARTICLE', 'BUSINESS_GROUP','ZONE'),
    )

    # -- GROUP DATAFRAME
    #output_columns = ['Sales', 'Profit']
    output_columns = ['sum.nbv', 'Sum(QTY)']  # new output
